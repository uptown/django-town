...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AddressComponent.ser_no'
        db.add_column(u'social_addresscomponent', 'ser_no',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AddressComponent.ser_no'
        db.delete_column(u'social_addresscomponent', 'ser_no')
    ...
    models = {
        ...
        'social.useremailverify': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2RHxPnR5K4xhksJVzAYCbryCN4mVx8oJAlCW11VXbNyVmfxx724Kzx1yTYAdp0ZI'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'social.userpasswordreset': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'MPO4H9xfTx4RL9MNSjYthUN5Xhh8hhbB9UZ4EsJg3JBwjL9JZOmw2bSTeajea6bh'", 'max_length': '64', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['social.User']", 'primary_key': 'True'})
        }
    }
