...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AddressComponent.parent'
        db.alter_column(u'social_addresscomponent', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.AddressComponent'], null=True))

    def backwards(self, orm):

        # Changing field 'AddressComponent.parent'
        db.alter_column(u'social_addresscomponent', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['social.AddressComponent']))
    ...
    models = {
        ...
        'social.useremailverify': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'Xi7O8UIHsifKNB1VOrd9OQh2dJmYNBdCaZZVnVZuPjGSYUFoLtiCPBuISuYlZvz0'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'social.userpasswordreset': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'V1rds8lXrkBdvYPkyn1lR2BU9EbORZ2qjAAQtEEDTdWeG5YtYCzVxkN9ACx9Mkq9'", 'max_length': '64', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['social.User']", 'primary_key': 'True'})
        }
    }
